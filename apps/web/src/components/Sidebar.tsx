...
function YipsWordmark() {
  return (
    <span className="inline-flex items-baseline gap-1.5 leading-none">
      <span className="text-sm font-bold tracking-tight text-foreground">Yips</span>
      <span className="text-sm font-medium tracking-[0.08em] text-muted-foreground/80 uppercase">
        GUI
      </span>
    </span>
  );
